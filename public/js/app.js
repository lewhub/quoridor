...
socket.on("user connected", function(data){
    ...
    // if (!window.localStorage["current_socket_id"] && !window.localStorage["player"] && data.counter === 0) {
    //     console.log("user one connected")
    //     window.localStorage["current_socket_id"] = id;
    //     window.localStorage["player"] = "user_one";
    //     socket.emit("user one connected")
    // }


    // if (window.localStorage["player"] !== "user_two") {
    //     window.localStorage["player"] = data.user_one; 
    // }
    
    // if (data.user_one === 0) {
    //     if (window.localStorage["user_one"] === 0) {
    //            window.localStorage["user_one"] = 1;
    //            socket.emit("user added", { user_one: 1, user_two: 0 })
    //     }
     
    // }
    // if (data.user_two === 0) {
    //     window.localStorage["user_two"] = 1;
    //     socket.emit("user two added", { user_one: 0, user_two: 1 });
    // }
})
...
socket.on("white pawn dropped", function(index){
    ...
    // var w_p = "<img id='white-pawn' src='./assets/white_pawn.png'>";
     ...
     console.log("white pawn was dropped... changing turns")
     change_turns();
    //  highlight_sq("#white-pawn")
})
socket.on("black pawn dropped", function(index){
    //  var b_p = "<img id='black-pawn' src='./assets/black_pawn.png'>";
     ...
     console.log("black pawn was dropped... changing turns");
     change_turns()
    //  highlight_sq("#black-pawn")
})
...
wall_btn.on("click", function(){
    ...
    $(".square").on("mouseleave", function(evt){
        ...
        if (sq.css("border-top-color") === "rgb(57, 183, 205)") {
            ...
            alert("Player 1: White Pawn has no barriers left.");
        }
    } else if (current_player === "2") {
    ...
    $(".square").on("mouseleave", function(evt){
        ...
        if (sq.css("border-top-color") === "rgb(57, 183, 205)") {
            ...
            alert("Player 2: Black Pawn has no barriers left.");
        }
    }
...
function highlight_sq(pawn) {
    ...
    //     var id =  $(top.children()[0]).attr("id")
    //     if (id === "white-pawn") {
    //         console.log("change top valid position for black pawn")
    //         top.droppable("destroy");
    //         if (!left.droppable("option", "addClasses") && !right.droppable("option", "addClasses") && !bottom.droppable("option", "addClasses")) {
    //             new_top.droppable({
    //             addClasses: true,
    //             accept: "#black-pawn",
    //             classes: {
    ...
    //         })
    //      } else {
    //          console.log("cannot jump over other player because there are still ways around that player.");
    //      }
    ...
    //      var id =  $(left.children()[0]).attr("id")
    //     if (id === "white-pawn") {
    //         console.log("change left valid position for black pawn")
    //         left.droppable("destroy");
    //         if (!top.droppable("option", "addClasses") && !right.droppable("option", "addClasses") && !bottom.droppable("option", "addClasses")) {
    //             new_left_black.droppable({
    //             addClasses: true,
    //             accept: "#black-pawn",
    //             classes: {
    //                 "ui-droppable-hover": h,
    ...
    //      var id =  $(right.children()[0]).attr("id")
    //     if (id === "white-pawn") {
    //         console.log("change right valid position for black pawn")
    //         right.droppable("destroy");
    //         if (!top.droppable("option", "addClasses") && !left.droppable("option", "addClasses") && !bottom.droppable("option", "addClasses")) {
    //             new_right_black.droppable({
    //             addClasses: true,
    //             accept: "#black-pawn",
    //             classes: {
    //                 "ui-droppable-hover": h,
    ...
    //                 sq.append(ui.draggable[0])
    //                 console.log(sq)
    //             disable_sq(bottom, top, left, pos, sq);
    //             // highlight_sq("#black-pawn")
    //             change_turns("1");
    //             }
    //         })
    ...
    //     var id =  $(bottom.children()[0]).attr("id")
    //     if (id === "white-pawn") {
    //         console.log("change top valid position for black pawn")
    //         bottom.droppable("destroy");
    //         if (!left.droppable("option", "addClasses") && !right.droppable("option", "addClasses") && !top.droppable("option", "addClasses")) {
    //             new_bottom.droppable({
    //             addClasses: true,
    //             accept: "#black-pawn",
    //             classes: {
    //                 "ui-droppable-hover": h,
